@extends('template')
@section('titulo', 'DTE GUARD - Clases')
@section('pagina', 'DTE GUARD - Clases')
@section('contenido')
@verbatim
<style>
    body,
...
<div id="app" v-loading.fullscreen.lock="loading" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)">
    <h2>Clases</h2>
    <button class="btn btn-success btn-sm btn-block my-2" @click="exportData(info,'Clases')" v-if="info.length>0"><i class="fa fa-file-excel-o"></i> Excel</button>
    <button type="button" class="btn btn-outline-primary btn-sm float-right" @click="openCrear()">Crear clase</button>
